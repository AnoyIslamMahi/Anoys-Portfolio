...
import { serviceWorks, Work } from "../data/works";
import { useEffect, useState } from "react";

const ServiceDetail = () => {
  const { id } = useParams<{ id: string }>();
  const service = id ? serviceWorks[id] : null;
    ...
    <div className="min-h-screen bg-dark text-white pt-32 pb-24 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <h1 className="text-6xl md:text-8xl font-display tracking-tighter mb-6">{service.title}</h1>
